...
from lib.datasets.jinnan_voc import jinnan
...
#  TODO 测试模型并计算mAP
def evaluate(sess, net, imdb, weights_filename='default', max_per_image=100, thresh=0.05):
...
if __name__ == '__main__':
    tfmodel = "F:\\dev-work-space\\deeplearning_space\\Faster-RCNN-TensorFlow-Python3.5\\" \
              "default\\jinnan\\default\\vgg16_faster_rcnn_iter_10000.ckpt"
    ...
    num_class = 6
    net.create_architecture(sess, "TEST", 6,
                            tag='default', anchor_scales=[8, 16, 32])
    saver = tf.train.Saver()
    saver.restore(sess, tfmodel)

    # print('Loaded network {:s}'.format(tfmodel))
    jinnan_test = jinnan(data_path='jinnan2_round1_val_20190222')
    weights_file_name = 'F:\\dev-work-space\\deeplearning_space\\Faster-RCNN-TensorFlow-Python3.5\\" \
              "default\\jinnan\\default\\vgg16_faster_rcnn_iter_10000'
    evaluate(sess, net, jinnan_test)